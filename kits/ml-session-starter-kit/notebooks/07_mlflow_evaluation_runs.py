...
# MAGIC <b>Where does the gold label come from?</b> Patients 1–180 are the <b>"both-agree"</b> cohort: a
...
# MAGIC
# MAGIC One row per patient 1–180 carrying **both** the note text *and* the structured HER2/ER/PR labels.

# COMMAND ----------

# DBTITLE 1,eval_biomarker_goldset — note text + structured gold labels (person 1–180) (PRE-BUILT)
# MAGIC %sql
