...
# MAGIC %md-sandbox
# MAGIC ## 1️⃣–2️⃣ Wrap ClinicalBERT's encoder as an MLflow pyfunc
# MAGIC
...
# MAGIC let us tell the governance story honestly with a model doing what it's actually good at.
# MAGIC </div>
