...
# MAGIC | **Trial C**, triple-negative | Breast cancer · **HER2 Negative** · **ER Negative** · **PR Negative** · age 18 to 75 |
# MAGIC
# MAGIC 📋 **The full, canonical eligibility card for all three trials (every `req_*` field, the eligible
# MAGIC counts, and the "one rule" for matching) lives in `SHARED_FOUNDATION.md`.** That is the single
# MAGIC source of truth. Do not re-derive the criteria from memory; read the card.
# MAGIC
