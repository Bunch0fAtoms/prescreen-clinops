...
# MAGIC | 4 | A job hammers the source **during the 11pm–8am batch window** it must stay out of. | `04` SLA window |
# MAGIC
...
# MAGIC   │  nb 04  SLA-WINDOW GUARD — skip 11pm–8am batch window      │  🛠️ you
# MAGIC   └──────────┬───────────────────────────────────────────────┘
# MAGIC              │  (guards pass)
# MAGIC              ▼
# MAGIC  ┌──────────────────────────────┐
...
# MAGIC | 04 | `04_sla_job_windows` | A runtime guard that skips the 11pm–8am SLA window + the Jobs schedule pattern | 🛠️ build the guard | Jennifer #9 |
