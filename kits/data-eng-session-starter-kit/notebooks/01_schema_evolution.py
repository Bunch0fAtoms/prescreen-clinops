...
# MAGIC     The source adds a new column next quarter. Make the ingest <b>absorb it safely</b> — no broken
# MAGIC     job, no silently-dropped data — with Delta <code>mergeSchema</code> (and the Auto Loader
